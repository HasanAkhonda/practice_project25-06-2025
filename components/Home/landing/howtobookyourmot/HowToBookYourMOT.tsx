...
const HowToBookYourMOT = () => {
    return (
        <div className='flex flex-col w-full container   gap-12 items-center px-6 md:px-12 lg:px-[188px] py-[60px] lg:py-[100px]   '>
            ...
            <div className='flex gap-6 m'>
                <div className='flex flex-col items-center gap-6'>
                    ...
                    <div className='flex flex-col items-center gap-3'>
                        ...
                        <p className='text-[16px] font-base text-gray-400   text-center'>
