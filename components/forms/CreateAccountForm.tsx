...
const CreateAccountForm = () => {
  ...
  return (
    <div className="w-full p-8 bg-white rounded-[10px] outline-1 outline-offset-[-1px] outline-green-500 flex flex-col justify-start items-center gap-12">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='w-full flex flex-col gap-6'>
        <div className='w-full flex flex-col gap-3'>
          ...
          <input
            ...
            className="text-zinc-400 text-base font-normal font-['Inter'] leading-normal h-14 px-2.5 rounded-lg outline-1 outline-offset-[-1px] outline-green-500 backdrop-blur-[5px]"
          />
