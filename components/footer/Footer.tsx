...
const Footer = () => {
    return (
        <div className="bg-green-500 ">
            <div className='max-w-[1600px] w-full  gap-8 mx-auto  flex flex-col md:flex-row justify-between items-center py-[40px] px-5 md:px-[188px] text-white text-sm font-medium'>
